...
private:
    vector<Tarea> tareas;
    const Seguimientotareas& seguimiento;

public:
    Gestiondetareas(const Seguimientotareas& seguimiento) : seguimiento(seguimiento) {}

    void agregartarea(string descripcion, string fechalimite, int progreso) {
...
class Seguimientoconsola : public Seguimientotareas {
public:
